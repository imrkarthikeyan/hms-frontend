    ...
    <div className="flex flex-col min-h-screen">
      <div className="bg-gray-800 top-0 w-full fixed text-white p-4 flex items-center border-b border-gray-500 z-10 h-[65px]">
        <div className="w-full flex justify-between items-center px-2 sm:px-5">
          <div className="text-yellow-300 font-bold flex gap-3 items-center">
      ...
      <div className='flex flex-1 items-center justify-center pt-28 px-4'>
        <form onSubmit={handleLogin} className="flex flex-col items-center w-full max-w-sm p-6 bg-white rounded-lg shadow-xl">
          <h2 className="text-2xl font-bold mb-4 text-center">Login as Student</h2>
          ...
          <button type="submit" className="bg-blue-600 text-white px-4 py-2 rounded w-full hover:bg-blue-700 cursor-pointer" disabled={loading}>
